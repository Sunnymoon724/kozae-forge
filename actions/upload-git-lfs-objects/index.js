...
const goDebug = process.env.GODEBUG ? `${process.env.GODEBUG},http2client=0` : 'http2client=0';
const environment = {...process.env, GIT_TERMINAL_PROMPT: '0', GCM_INTERACTIVE: 'Never', GODEBUG: goDebug, GIT_CONFIG_COUNT: '3', GIT_CONFIG_KEY_0: 'http.extraheader', GIT_CONFIG_VALUE_0: `AUTHORIZATION: Basic ${authorization}`, GIT_CONFIG_KEY_1: 'lfs.concurrenttransfers', GIT_CONFIG_VALUE_1: process.env.INPUT_CONCURRENT_TRANSFERS, GIT_CONFIG_KEY_2: 'lfs.transfer.maxretries', GIT_CONFIG_VALUE_2: process.env.INPUT_MAX_RETRIES};
