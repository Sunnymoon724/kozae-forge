...
git(['lfs', 'install']); git(['remote', 'remove', process.env.INPUT_REMOTE_NAME], true); git(['remote', 'add', process.env.INPUT_REMOTE_NAME, `https://github.com/${process.env.INPUT_REPOSITORY}.git`]); git(['config', `lfs.https://github.com/${process.env.INPUT_REPOSITORY}.git/info/lfs.access`, 'basic']);
