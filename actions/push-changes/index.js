...
const result = spawnSync('git', ['push', 'origin', `HEAD:${process.env.INPUT_BRANCH}`], {cwd: process.env.INPUT_DESTINATION_DIRECTORY, stdio: 'inherit', env: {...process.env, GIT_TERMINAL_PROMPT: '0'}, timeout: 300000});
