...
const result = spawnSync('git', ['push', 'origin', `HEAD:${process.env.INPUT_BRANCH}`], {cwd: process.env.INPUT_DESTINATION_DIRECTORY, stdio: 'inherit', env: {...process.env, GIT_TERMINAL_PROMPT: '0', GCM_INTERACTIVE: 'Never', GIT_CONFIG_COUNT: '1', GIT_CONFIG_KEY_0: 'http.extraheader', GIT_CONFIG_VALUE_0: `AUTHORIZATION: Basic ${authorization}`}, timeout: 300000});
