...
const result = spawnSync('git', ['-c', `http.extraheader=AUTHORIZATION: basic ${authorization}`, 'clone', `https://github.com/${process.env.INPUT_REPOSITORY}.git`, process.env.INPUT_DESTINATION_DIRECTORY], {stdio: 'inherit', env: {...process.env, GIT_TERMINAL_PROMPT: '0'}, timeout: 300000});
